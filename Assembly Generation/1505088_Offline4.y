...
declaration_list : declaration_list COMMA ID
			{
				...
				else
				{
					...
					else
					{
						...
						fprintf(logout,"\n%s\n\n",$$->symboPrint.c_str());
						idVect.push_back($3->getName() + to_string(table.getScopeNum()));
						ins->setString($3->getName() + to_string(table.getScopeNum()));
						table.allScope();
					}
				}
			}
 		  | declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
			{
				...
				{
					string name = $3->getName()+to_string(table.getScopeNum());
 		  ...
 		  | ID
			{
				...
				{
					string name = $1->getName()+to_string(table.getScopeNum());
...
variable : ID
		{
			...
			else
			{
				...
				//$$ = var;
				$$ = new symboInfo($1->getName(),$1->getType());
				//$$ = tem;
				$$->symboPrint = $1->getName();
				fprintf(logout,"\n%s\n\n",$$->symboPrint.c_str());
				...
				{
					idVect.push_back($1->getName()+to_string(table.getScopeNum()));
	 	...
	 	| ID LTHIRD expression RTHIRD
		{
			...
			if(ara == NULL)
			{
				...
				{
					arrayVect.push_back($1->getName()+to_string(table.getScopeNum()));
	   ...
	   | variable ASSIGNOP logic_expression
		{
			...
			{
				//cout<<"\n\nhi";
				$$->code += "\tMOV " + $1->getString() + "[BX], AX\n";
			}
			else
			{
				$$->code += "\tMOV " + $1->getString()+ ", AX\n";
			}
		 ...
		 | rel_expression LOGICOP rel_expression
			{
				...
				if($2->getName() == "&&"){
					...
					*/
					...
					char *temp = newTemp();
					$$->code += "\tMOV AX, " + $1->getString() + "\n";
					$$->code += "\tCMP AX, 0\n";
					$$->code += "\tJE " + string(lable) + "\n";
					$$->code += "\tMOV BX, " + $3->getString() + "\n";
					$$->code += "\tCMP BX, 0\n";
					$$->code += "\tJE " + string(lable) + "\n";
					$$->code += "\tMOV " + string(temp) + ", 1\n";
					$$->code += "\tJMP " + string(lable2) + "\n";
					$$->code += string(lable) + ":\n";
...
rel_expression	: simple_expression
		...
		| simple_expression RELOP simple_expression
		{
			...
			if($2->getName() == "<")
			{
				$$->code += "\tJL " + string(lable) + "\n";
			}
			else if($2->getName() == "<=")
			{
				$$->code += "\tJLE " + string(lable) + "\n";
			}
			else if($2->getName() == ">")
			{
				$$->code += "\tJG " + string(lable) + "\n";
			}
			else if($2->getName() == ">=")
			{
				$$->code += "\tJGE " + string(lable) + "\n";
			}
			else if($2->getName() == "==")
			{
				$$->code += "\tJE " + string(lable) + "\n";
		  ...
		  | simple_expression ADDOP term
			{
				...
				{
					$$->code += "\tMOV AX, " + $1->getString() +"\n";
					$$->code += "\tADD AX, " + $3->getString() + "\n";
					$$->code += "\tMOV " + string(temp) + ",AX\n"; 
				}
				else if($2->getName() == "-")
				{
					$$->code += "\tMOV AX, " + $1->getString() +"\n";
					$$->code += "\tSUB AX, " + $3->getString() + "\n";
					$$->code += "\tMOV " + string(temp) + ",AX\n";
				}
				$$->setString(temp);
				//$$->setType("ID");
...
unary_expression : ADDOP unary_expression
		{
			...
			if($1->getName() == "-"){
				$$->symboPrint = $1->getName() + $2->symboPrint;
				fprintf(logout,"\n%s\n\n",$$->symboPrint.c_str());
				$$->code += "\tMOV AX, " + $2->getString() + "\n";
				$$->code += "\tNEG AX\n";
				$$->code += "\tMOV " + $2->getString() + ", AX\n";
			}
		}  
